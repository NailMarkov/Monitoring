...
const dev = gulp.series(clean, copy, sprite, gulp.parallel(pug, styles), syncServer);
const build = gulp.series(clean, copy, sprite, gulp.parallel(optimizeJpg, optimizePng, optimizeSvg, pug, styles), syncServer);
